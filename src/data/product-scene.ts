...
export const productScene: Record<string, { desktop: SceneLayer[]; phone: SceneLayer[] }> = {
  "garnish": {
    desktop: [
      ...
      { paint: "linear-gradient(0deg, #f8f7f5 0%, rgba(248, 247, 245, 0) 100%)", m: [1199.6035, 0, 0, 211.4219, 2.1982, 586.7891] },
    ...
    phone: [
      ...
      { paint: "linear-gradient(1.8238deg, #ebe1d1 10.511%, #dfceb4 67.3903%)", m: [462.4223, 0, 0, 404.2272, -73.2715, 4.8769] },
      { src: "/images/scene-48330e21f1130.webp", m: [231.6396, 0, 0, 261.7003, 148.3555, 105.0342] },
      { paint: "linear-gradient(0.0001deg, #eee6d8 67.0382%, rgba(238, 230, 216, 0) 77.814%)", m: [371.0146, 0, 0, 62.5881, -8.042, 346.2606] },
  ...
  "sugar-free": {
    desktop: [
      ...
      { src: "/images/scene-f16e70efc5898x432.webp", m: [-22.1914, 208.5744, -141.3663, -15.0408, 167.9235, 577.0702], blur: 0.0227 },
      ...
      { src: "/images/scene-f16e70efc5898x432.webp", m: [32.9987, 152.8733, 103.6135, -22.3657, 569.95, 381.684], blur: 0.0305 },
      ...
      { paint: "linear-gradient(-90.8561deg, rgba(232, 242, 233, 0) 97.4054%)", m: [773.5, 0, 0, 685.1641, 496.7651, 118.3516] },
      { paint: "linear-gradient(-88.7188deg, #e8f2e9 24.6575%, rgba(232, 242, 233, 0) 96.153%)", m: [-186.6956, 0, 0, -645.6128, 226.9141, 824.9297] },
      { paint: "linear-gradient(-88.876deg, #e8f2e9 24.3001%, rgba(232, 242, 233, 0) 96.9894%)", m: [212.8031, 0, 0, 645.6128, 457.9619, 179.3203] },
      { paint: "linear-gradient(0deg, #f8f7f5 0%, rgba(248, 247, 245, 0) 100%)", m: [1199.6035, 0, 0, 211.4219, 0, 596.7891] },
    ...
    phone: [
      ...
      { paint: "linear-gradient(52.3862deg, #a4c4b0 29.8103%, rgba(164, 196, 176, 0) 68.9122%)", m: [111.8805, -14.267, 5.6977, 44.6811, 134.7051, 311.1715], round: true },
  ...
  "tea": {
    desktop: [
      ...
      { paint: "linear-gradient(0deg, #f8f7f5 0%, rgba(0, 0, 0, 0) 100%)", m: [1199.6035, 0, 0, 205.9609, 0, 606.7891] },
    ],
    phone: [
