...
export type SceneLayer = {
  ...
  back?: true;
  /** Explicit stacking tier where a foreground cut-out must clear its ground. */
  z?: number;
...
export const productScene: Record<string, { desktop: SceneLayer[]; phone: SceneLayer[] }> = {
  ...
  "sugar-free": {
    desktop: [
      ...
      { paint: "#a4c4b0", m: [239.6411, -30.5591, 12.2042, 95.7039, 263.8083, 627.4891], mask: [46.9141, 118.3516, 610.6379, 626.2354], round: true, back: true, z: 0 },
      ...
      { src: "/images/scene-f16e70efc7127x6439.webp", m: [82.5183, 0, 0, 157.9891, 427.935, 379.345], mask: [46.9141, 118.3516, 610.6379, 626.2354], z: 3 },
      ...
      { paint: "transparent", m: [54.7782, 0, 0, 34.3454, 138.3372, 634.8514], mask: [46.9141, 118.3516, 610.6379, 626.2354], round: true },
      ...
      { paint: "transparent", m: [54.7782, 0, 0, 34.3454, 93.8748, 622.0819], round: true },
    ],
    phone: [
      ...
      { paint: "linear-gradient(52.3862deg, #a4c4b0 29.8103%, rgba(164, 196, 176, 0) 68.9122%)", m: [111.8805, -14.267, 5.6977, 44.6811, 134.7051, 311.1715], mask: [-360, 108, 1080, 316.6348], round: true, back: true, z: 0 },
      ...
      { src: "/images/scene-f16e70efc7127x6439.webp", m: [48.6484, 0, 0, 93.1421, 224.6299, 209.3077], mask: [-360, 108, 1080, 316.6348], z: 3 },
      ...
      { paint: "transparent", m: [33.2112, 0, 0, 20.8231, 288.3193, 176.562], mask: [-360, 108, 1080, 316.6348], round: true },
      { paint: "transparent", m: [33.2112, 0, 0, 20.8231, 287.7959, 176.9604], round: true },
    ],
  },
  "tea": {
    desktop: [
    ...
    phone: [
      ...
      { paint: "transparent", m: [360, 0, 0, 404.166, 0, 108], back: true },
