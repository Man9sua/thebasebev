...
export const productScene: Record<string, { desktop: SceneLayer[]; phone: SceneLayer[] }> = {
  "garnish": {
    ...
    phone: [
      { paint: "linear-gradient(1.8238deg, #ebe1d1 10.511%, #dfceb4 67.3903%)", m: [462.4223, 0, 0, 404.2272, -73.2715, 4.8769], back: true, mask: [0, 107.4843, 360, 316.6827] },
      { src: "/images/scene-48330e21f1130.webp", m: [231.6396, 0, 0, 261.7003, 148.3555, 105.0342], back: true, mask: [0, 107.4843, 360, 316.6827] },
      { paint: "linear-gradient(0.0001deg, #eee6d8 67.0382%, rgba(238, 230, 216, 0) 77.814%)", m: [371.0146, 0, 0, 62.5881, -8.042, 346.2606], back: true, mask: [0, 107.4843, 360, 316.6827] },
  ...
  "sugar-free": {
    ...
    phone: [
      { src: "/images/scene-f16e70efc5898x432b801.webp", m: [-13.0829, 122.9645, -83.3422, -8.8673, 71.3408, 325.8765], back: true, mask: [0, 108, 360, 316.6348] },
      ...
      { src: "/images/scene-f16e70efc5898x432b800.webp", m: [19.4543, 90.1261, 61.0851, -13.1856, 308.3545, 210.6866], mask: [0, 108, 360, 316.6348] },
