 ...
 * a filter is taken in the box's own space and magnified with it.
 *
...
export const productScene: Record<string, { desktop: SceneLayer[]; phone: SceneLayer[] }> = {
  "garnish": {
    desktop: [
      ...
      { paint: "linear-gradient(0deg, #eee6d8 67.038%, rgba(238, 230, 216, 0) 77.8139%)", m: [471.6326, 0, 0, 532.7571, 249.5811, 104.4805] },
      { paint: "linear-gradient(0.0001deg, #eee6d8 67.038%, rgba(238, 230, 216, 0) 77.8139%)", m: [766.877, 0, 0, 244.5977, -49.8948, 545.8867] },
      { paint: "linear-gradient(0deg, #eee6d8 67.038%, rgba(238, 230, 216, 0) 77.8139%)", m: [0, -693.7725, 680.3472, 0, 536.6072, 795.0469] },
    ...
    phone: [
      { paint: "#dfceb4", m: [-360, 0, 0, 523.0701, 360, 376.7144] },
      { paint: "linear-gradient(1.8238deg, #ebe1d1 10.511%, #dfceb4 67.3903%)", m: [462.4223, 0, 0, 404.2272, -73.2715, 4.8769], mask: [0, 107.4843, 360, 316.6827] },
      { src: "/images/scene-48330e21f1130.webp", m: [231.6396, 0, 0, 261.7003, 148.3555, 105.0342], mask: [0, 107.4843, 360, 316.6827] },
      { paint: "linear-gradient(0.0001deg, #eee6d8 67.0382%, rgba(238, 230, 216, 0) 77.814%)", m: [371.0146, 0, 0, 62.5881, -8.042, 346.2606], mask: [0, 107.4843, 360, 316.6827] },
  ...
  "sugar-free": {
    desktop: [
      ...
      { src: "/images/scene-f16e70efc5898x432.webp", m: [-22.1914, 208.5744, -141.3663, -15.0408, 167.9235, 577.0702], mask: [46.9141, 118.3516, 610.6379, 626.2354], blur: 0.0227 },
      ...
      { src: "/images/scene-f16e70efc5898x432.webp", m: [32.9987, 152.8733, 103.6135, -22.3657, 569.95, 381.684], mask: [46.9141, 118.3516, 610.6379, 626.2354], blur: 0.0305 },
    ...
    phone: [
      { paint: "#000000", m: [462.4223, 0, 0, 404.166, 358.7285, 4.9375] },
      { src: "/images/scene-f16e70efc5898x432.webp", m: [-13.0829, 122.9645, -83.3422, -8.8673, 71.3408, 325.8765], mask: [0, 108, 360, 316.6348], blur: 0.0386 },
      { src: "/images/scene-5f33d9e4f813.webp", m: [138.3948, -110.6804, 89.9548, 112.4795, 122.5156, 99.6065], mask: [0, 108, 360, 316.6348] },
      { src: "/images/scene-cdd1d94df813.webp", m: [150.3929, 46.9692, -38.174, 122.231, -14.4932, 181.9322], mask: [0, 108, 360, 316.6348] },
      { src: "/images/scene-3c519f85f813.webp", m: [183.3918, -59.5816, 48.4246, 149.0505, 214.5391, 255.2784], mask: [0, 108, 360, 316.6348] },
      { src: "/images/scene-f16e70efc0x0.webp", m: [-70.0155, 61.2171, 69.0011, 78.9183, 230.1699, 209.3077], mask: [0, 108, 360, 316.6348] },
      { src: "/images/scene-f16e70efc5898x432.webp", m: [71.6846, 0, 0, 48.5859, 66.1064, 191.1695], mask: [0, 108, 360, 316.6348] },
      { paint: "linear-gradient(52.3862deg, #a4c4b0 29.8103%, rgba(164, 196, 176, 0) 68.9122%)", m: [111.8805, -14.267, 5.6977, 44.6811, 134.7051, 311.1715], mask: [0, 108, 360, 316.6348], round: true },
      { src: "/images/scene-f16e70efc5898x432.webp", m: [19.4543, 90.1261, 61.0851, -13.1856, 308.3545, 210.6866], mask: [0, 108, 360, 316.6348], blur: 0.0517 },
      { src: "/images/scene-f16e70efc7127x6439.webp", m: [48.6484, 0, 0, 93.1421, 224.6299, 209.3077], mask: [0, 108, 360, 316.6348] },
      { src: "/images/scene-f16e70efc0x0.webp", m: [-59.7383, 71.2897, -80.3545, -67.3342, 220.6777, 184.5928], mask: [0, 108, 360, 316.6348] },
      { src: "/images/scene-f16e70efc0x0.webp", m: [-24.033, 89.8446, 101.2687, 27.0888, -37.6865, 98.5279], mask: [0, 108, 360, 316.6348] },
      { src: "/images/scene-0a906e54c0x3180.webp", m: [169.6461, 0, 0, 184.4492, 69.1582, 172.525], mask: [0, 108, 360, 316.6348] },
      { paint: "#ffffff", m: [33.2112, 0, 0, 20.8231, 288.3193, 176.562], mask: [0, 108, 360, 316.6348], round: true },
      { paint: "#e0e9e2", m: [-360, 0, 0, 523.0701, 360, 376.7144] },
  ...
  "tea": {
    ...
    phone: [
      ...
      { paint: "#5e5a57", m: [-360, 0, 0, 523.0701, 360, 376.7144] },
      { paint: "#ffffff", m: [33.2112, 0, 0, 20.8231, 287.7959, 176.9604], round: true },
