...
function t972_showWidget(widgetBtn,cookiesBanner){if(widgetBtn){widgetBtn.classList.add('t972__widget-button_active');var closeAriaLabel=widgetBtn.getAttribute('data-alt-aria-label')||'';var openAriaLabel=widgetBtn.getAttribute('aria-label')||'';widgetBtn.setAttribute('aria-label',closeAriaLabel);widgetBtn.setAttribute('data-alt-aria-label',openAriaLabel)}
cookiesBanner.classList.add('t972__banner_show')}
function t972_hideWidget(widgetBtn,cookiesBanner,settingsBanner){if(widgetBtn){if(widgetBtn)widgetBtn.classList.remove('t972__widget-button_active');var openAriaLabel=widgetBtn.getAttribute('data-alt-aria-label')||'';var closeAriaLabel=widgetBtn.getAttribute('aria-label')||'';widgetBtn.setAttribute('aria-label',openAriaLabel);widgetBtn.setAttribute('data-alt-aria-label',closeAriaLabel)}
